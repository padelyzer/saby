#!/usr/bin/env python3
"""
Trading Bot V2.5 - Versión para Fly.io
Incluye servidor HTTP básico que Fly.io necesita
"""
...
class TradingBotV25:
    """
    Sistema principal de trading V2.5 para Fly.io
    """
    ...
    def run_forever(self):
        """Loop principal para Fly.io"""
        self.logger.info("🚀 Trading Bot V2.5 iniciado en Fly.io")
...
def start_http_server():
    """Inicia servidor HTTP para health checks de Fly.io"""
